...
Write-Host '[*] Tai installer ~531MB (cho vai phut)...'
(New-Object Net.WebClient).DownloadFile('https://github.com/glvgaming369/shopee369-releases/releases/download/v0.1.3/Shopee369-Setup-0.1.3.exe', $exe)
